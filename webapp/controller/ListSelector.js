sap.ui.define([
  ...
  "use strict";
  return BaseObject.extend("z_tech_appeal.controller.ListSelector", {

    /**
     * Provides a convenience API for selecting list items. All the functions will wait\
     * until the initial load of the a List passed to the instance by the setBoundMasterList
     * function.
     * @class
     * @public
     * @alias Z_MSG_TECHV1.Z_MSG_TECH_V1.controller.ListSelector
     */
     ...
     * @return {Z_MSG_TECHV1.Z_MSG_TECH_V1.model.ListSelector} the list selector object for method chaining
     * @public
     */
